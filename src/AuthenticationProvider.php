...
class AuthenticationProvider extends ServiceProvider {
    ...
    /**
         * Generate a JWT with an object adding params for the generation
         *
         * @param object          $payload PHP Object
         * @param string          $aud The Audience URL.
         *
         * @return string A signed JWT
    */
    public function generateJWTToken(object $payload, string $aud = null): string {
        $data_object = (array) $payload;
